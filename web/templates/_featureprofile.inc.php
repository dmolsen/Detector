...
<?php 
	...
	if (Detector::$foundIn != 'archive') {
		createFT($ua,$perUserFeatures,"Detector Per User Test Features","pu-","To learn more about per user tests and their purpose please <a href=\"https://github.com/dmolsen/Detector/wiki/Detector-Test-Tutorial\">review the test tutorial.</a>");
